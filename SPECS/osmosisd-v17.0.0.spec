...
Version:      %{_versiontag}
Name:         osmosisd-v17.0.0
Release:      %{_releasetag}%{?dist}
Summary:      Osmosis Node Binary Pack for v17.0.0
...
mkdir -p ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/cosmovisor/upgrades/v17/bin
mkdir -p ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/cosmovisor/upgrades/v17/lib/

# Install the newly built binaries
cp -v ${RPM_BUILD_DIR}/osmosis/build/osmosisd                                                             ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/cosmovisor/upgrades/v17/bin/
cp -v ${RPM_BUILD_DIR}'/go/pkg/mod/github.com/!cosm!wasm/wasmvm@v1.2.3/internal/api/libwasmvm.x86_64.so'  ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/cosmovisor/upgrades/v17/lib/
chmod 644  ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/cosmovisor/upgrades/v17/lib/*
