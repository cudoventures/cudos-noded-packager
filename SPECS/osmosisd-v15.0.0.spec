...
Version:      %{_versiontag}
Name:         osmosisd-v15.0.0
Release:      %{_releasetag}%{?dist}
Summary:      Osmosis Node Binary Pack for v15.0.0
...
cp -v ${RPM_BUILD_DIR}'/go/pkg/mod/github.com/!cosm!wasm/wasmvm@v1.1.1/internal/api/libwasmvm.x86_64.so'  ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/cosmovisor/upgrades/v15/lib/
