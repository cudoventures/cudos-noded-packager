...
echo "P \"Osmosis Consensus Level\" signed=$MASK1|missing=$MASK0;:1;:$NUMVALS|num_vals=$NUMVALS|active_vote=$ACTIVEVOTE|tot_vote=$TOTVOTE|consensus=$CONS;75:;66: Signed by $MASK1 out of $NUMVALS ($CONS)"
