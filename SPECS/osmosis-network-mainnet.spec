...
#
# Contains the Network definition files for the Osmosis Mainnet network
#

Name:         osmosis-network-mainnet
Version:      %{_versiontag}
Release:      %{_releasetag}%{?dist}
Summary:      osmosis Mainnet Network Definition Files

License:      GPL3
URL:          https://github.com/osmosis-labs/osmosis

Source0:      osmosis-network-mainnet_config.tar.gz
...
%description
Osmosis Mainnet Network Definition Files

%prep
echo -e "\n\n=== prep section ===\n\n"
tar -C ${RPM_SOURCE_DIR} -xzf ${RPM_SOURCE_DIR}/osmosis-network-mainnet_config.tar.gz
...
cp -v ${RPM_SOURCE_DIR}/osmosis-network-mainnet_config/genesis.json                   ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/config/
cp -v ${RPM_SOURCE_DIR}/osmosis-network-mainnet_config/persistent-peers.config        ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/config/
cp -v ${RPM_SOURCE_DIR}/osmosis-network-mainnet_config/seeds.config                   ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/config/
cp -v ${RPM_SOURCE_DIR}/osmosis-network-mainnet_config/state-sync-rpc-servers.config  ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/config/
cp -v ${RPM_SOURCE_DIR}/osmosis-network-mainnet_config/unconditional-peers.config     ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/config/
cp -v ${RPM_SOURCE_DIR}/osmosis-network-mainnet_config/private-peers.config           ${RPM_BUILD_ROOT}/var/lib/osmosis/.osmosisd/config/
