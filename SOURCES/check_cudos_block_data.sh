...
echo "P \"Cudos Node Block Processing Time\" block_proc=$BLOCK_PROC|sum=$BLOCK_PROC_SUM_BC|count=$BLOCK_PROC_COUNT_BC Block Processing Time: $BLOCK_PROC"
...
then
	...
	echo "P \"Cudos Node Block Interval\" block_interval=$BLOCK_INTERVAL;4:7;0:9|sum=$BLOCK_INTERVAL_SUM_BC|count=$BLOCK_INTERVAL_COUNT_BC Block Interval: $BLOCK_INTERVAL"
else
